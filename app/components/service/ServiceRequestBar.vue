...
<template>
  <div class="fixed inset-x-6 bottom-6 z-40 rounded-2xl border border-white/10 bg-black/60 p-3 shadow-2xl backdrop-blur">
    <div class="mb-2 flex items-center justify-between">
      <p class="text-xs font-semibold uppercase tracking-[.16em] text-primary/80">
        Service Requests
      </p>
      <AppBadge :variant="serviceRequests.hasPending ? 'accent' : 'muted'">
